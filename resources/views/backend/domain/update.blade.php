        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.domain.update', $domain->id) }}" class="needs-validation"
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('backend.domain')</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="mb-3">
                                                ...
                                                <select name="exchange" class="form-control" required>
                                                    ...
                                                    <option value="AZN" {{ ($domain->exchange == 'AZN') ? 'selected' : '' }}>AZN</option>
                                                    <option value="USD" {{ ($domain->exchange == 'USD') ? 'selected' : '' }}>USD</option>
                                                    <option value="RUBL" {{ ($domain->exchange == 'RUBL') ? 'selected' : '' }}>RUBL</option>
                                                </select>
                                            </div>
                                            <div class="valid-feedback">
