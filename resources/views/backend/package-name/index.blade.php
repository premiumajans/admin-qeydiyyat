                ...
                <div class="card-body">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">@lang('menus.package-name'):</h4>
                            <a href="{{ route('backend.package-name.create') }}" class="btn btn-primary mb-3"><i
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $packageName->translate('az')->title }}</td>
                                <td class="text-center">{{ $packageName->translate('az')->price }}</td>
                                <td class="text-center">{{ $packageName->alt }}</td>
                                <td>{{ date('d.m.Y H:i:s',strtotime($packageName->created_at))}}</td>
                                <td class="text-center">
                                    <a class="btn btn-primary"
                                        href={{ route('backend.package-name.edit',$packageName->id) }}>
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger"
                                        href="{{ route('backend.package-name.destroy',$packageName->id) }}">
