        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.package-components.update',$packageComponent->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('menus.package-components')</h4>
                                        </div>
                                    </div>
                                            ...
                                            <div class="tab-pane @if($loop->first) active show @endif"
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="title[{{ $lan->code }}]" type="text"
                                                                class="form-control" required=""
                                                                rows="6">{{ $packageComponent->translate($lan->code)->title }}
                                                        </textarea>
