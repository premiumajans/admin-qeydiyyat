        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.partner.update', $partner->id) }}" class="needs-validation"
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('menus.partner')</h4>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label>@lang('backend.image'):</label>
                                        <div>
                                            <img width="100%" height="auto" src="{{ asset($partner->image) }}">
                                        </div>
                                    </div>
                                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <div class="form-group row">
                                            <div class="mb-3">
                                                ...
                                                <input name="link" type="text" value="{{ $partner->link }}"
