        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.team.update',$team->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('menus.team')</h4>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label>@lang('backend.image'):</label>
                                        <div>
                                            <img width="100%" height="auto" src="{{ asset($team->image) }}">
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="position[{{ $lan->code }}]" type="text"
                                                                value="{{ $team->translate($lan->code)->position }}"
                                                                class="form-control" required=""
                                                                data-parsley-minlength="6"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="alt[{{ $lan->code }}]" type="text"
                                                                value="{{ $team->translate($lan->code)->alt }}"
                                                                class="form-control" 
                                                                data-parsley-minlength="6"
