        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.contact-info.update', $contactInfo->id) }}"
                                        ...
                                        <div class="form-group row">
                                            <div class="mb-3">
                                                ...
                                                <input name="title" type="text" class="form-control" required=""
                                                    data-parsley-minlength="6" value="{{ $contactInfo->title }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="link" type="text" class="form-control" rows="6">{{ $contactInfo->link }}</textarea>
                                                <div class="valid-feedback">
