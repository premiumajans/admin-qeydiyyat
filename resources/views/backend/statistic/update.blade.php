        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.statistic.update',$statistic->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.new') @lang('backend.statistic')</h4>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="title[{{ $lan->code }}]" type="text"
                                                               class="form-control" required=""
                                                               data-parsley-minlength="6"
                                                               value="{{ $statistic->translate($lan->code)->title }}">
                                                        <div class="valid-feedback">
