        ...
        <td bgcolor="#048da6" align="center" style="padding: 0px 10px 0px 10px">
            ...
            >
                ...
                "
                    >
                        <img
                            src="https://i.ibb.co/vjwZkvm/logo.png"
                            width="125"
                            height="120"
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
            ...
            >
                ...
                "
                    >
                        <p style="margin: 0">
                            <a href="{{ route('frontend.verifyMail',['id' => $id,'token' => $token])}}" target="_blank"
                               style="color: #048da6"
            ...
            >
                ...
                "
                    >
                        ...
                        <p style="margin: 0">
                            <a href="{{ route('frontend.contact-us-page') }}" target="_blank" style="color: #048da6"
