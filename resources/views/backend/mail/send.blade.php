...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <!-- LOGO -->
    <tr>
        <td bgcolor="#048da6" align="center">
    ...
    <tr>
        <td bgcolor="#048da6" align="center" style="padding: 0px 10px 0px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                <tr>
                  ...
                  letter-spacing: 4px;
                  line-height: 48px;">
                        <img src="https://i.ibb.co/vjwZkvm/logo.png" width="125" height="120" style="display: block; border: 0px" />
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                ...
                ">
                        ...
                        <p style="margin: 0">
                            <a href="{{ route('frontend.contact-us-page') }}" target="_blank" style="color: #048da6"> Daha çox köməyə ehtiyacınız var?</a>
                        </p>
                    </td>
                    <td bgcolor="#FFECD1" align="center" style="
                  padding: 30px 30px 30px 30px;
                ...
                ">
                        ...
                        <p style="margin: 0">
                            <a href="{{ route('frontend.contact-us-page') }}" target="_blank" style="color: #048da6"> Abonəlikdən imtina et.</a>
                        </p>
                    </td>
                </tr>
            </table>
